...
def parse_raw_judgements(life, target_id):
	lfe.execute_raw(life, 'judge', 'trust', break_on_false=False, target_id=target_id) * 100
	if lfe.execute_raw(life, 'judge', 'break_trust', break_on_true=True, break_on_false=False, target_id=target_id):
