...
def create_function_map():
	FUNCTION_MAP.update({'is_family': stats.is_family,
		...
		'is_target_group_friendly': lambda life, life_id: groups.get_group_memory(life,brain.knows_alife_by_id(life, life_id)['group'], 'alignment')=='trust',
		'is_target_group_hostile': lambda life, life_id: groups.get_group_memory(life, brain.knows_alife_by_id(life, life_id)['group'], 'alignment')=='hostile',
	    'is_target_group_neutral': lambda life, life_id: groups.get_group_memory(life, brain.knows_alife_by_id(life, life_id)['group'], 'alignment')=='neutral',
		'is_group_friendly': stats.is_target_group_friendly,
		...
		'claim_hostile': lambda life, target, **kwargs: stats.establish_hostile(life, kwargs['hostile']),
