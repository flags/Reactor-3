...
def tick(life, alife_seen, alife_not_seen, targets_seen, targets_not_seen, source_map):
	...
	for target in _potential_talking_targets:
		...
		if not 'player' in target and not lfe.get_memory(life, matches={'text': 'met', 'target': target['id']}) and stats.desires_life(life, target['id']):
			...
			start_dialog(life, target['id'], 'introduction-negative')
			print '2neg'
