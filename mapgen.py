...
def create_buildings():
	BUILDINGS['supermarket'] = {'chunks': {'shopping': {'type': 'interior',
	                                                  'chunks': 3,
	                                                  'doors': ['office', 'checkout', 'checkout 2'],
	                                                  'floor': [{'x_mod_min': 0,
	                                                             'x_mod_max': 1,
	                                                             'y_mod_min': 0,
	                                                             'y_mod_max': 1,
	                                     ...
	                                     'checkout': {'type': 'interior',
	                                                  'chunks': 1,
	                                                  'doors': ['shopping', 'parking lot', 'checkout 2'],
	                                                  'floor': [{'x_mod_min': 0,
	                                                             'x_mod_max': 1,
	                                                             'y_mod_min': 0,
	                                                             'y_mod_max': 1,
	                                                  ...
	                                                  'flags': {'doorways': True},
	                                                  'walls': {'tiles': [tiles.WALL_TILE]}},
	                                     'checkout 2': {'type': 'interior',
	                                                  'chunks': 1,
	                                                  'doors': ['checkout', 'shopping'],
	                                                  'floor': [{'x_mod_min': 0,
	                                                             'x_mod_max': 1,
	                                                             'y_mod_min': 0,
	                                                             'y_mod_max': 1,
	...
	BUILDINGS['house_2'] = {'chunks': {'sidewalk': {'type': 'exterior',
	                                 ...
	                                 'kitchen': {'type': 'interior',
	                                             'chunks': 2,
	                                             'doors': ['landing', 'pantry', 'living room'],
	                                             'floor': [{'x_mod_min': 0,
	                                                        'x_mod_max': 1,
	                                                        'y_mod_min': 0,
	                                                        'y_mod_max': 1,
	...
	BUILDINGS['workshop_1'] = {'chunks': {'porch': {'type': 'exterior',
	                                                'chunks': 1,
	                                                'doors': ['lobby'],
	                                                'flags': {},
	                                                'floor': [{'x_mod_min': 0,
				...
				for x in range(0, WORLD_INFO['chunk_size']):
					...
					if _room['type'] == 'interior':
						if (x == 0 and not (-1, 0) in _doors_in) or (y == 0 and not (0, -1) in _doors_in) or (x == WORLD_INFO['chunk_size']-1 and not (1, 0) in _doors_in) or (y == WORLD_INFO['chunk_size']-1 and not (0, 1) in _doors_in):
							...
							for z in range(4):
								if not 'doorways' in _room['flags'] or not _room['flags']['doorways']:
									break
